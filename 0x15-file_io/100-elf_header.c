...
/**
 * print_magic - A fuction that prints the magic numbers of an ELF header.
 * @e_ident: A pointer to an array containing the ELF magic numbers.
...
/**
 * print_class - Afunction that prints the class of an ELF header.
...
/**
 * close_elf - A functio that closes an ELF file.
